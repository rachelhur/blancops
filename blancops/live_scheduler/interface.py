...
class CLIInterface(BaseInterface):
    ...
    def get_user_decision(self):
        while True:
            resp = input("Approve this chunk? [Y]es, [N]o (mask fields): ").strip().upper()
            if resp == 'Y':
